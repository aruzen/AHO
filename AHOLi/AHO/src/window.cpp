...
aho::window::Window::Window(engine::EngineAccessor engine, std::shared_ptr<vsl::Window::WindowData> vsl_data, std::shared_ptr<aho::window::WindowData> aho_data) : engine(engine), VSL_NAMESPACE::Window(std::move(vsl_data)) {
