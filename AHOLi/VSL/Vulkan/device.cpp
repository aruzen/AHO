...
template<bool V>
std::shared_ptr<VSL_NAMESPACE::_impl::LogicalDevice_impl> VSL_NAMESPACE::_LogicalDeviceGraphicCreator<V>::create(VSL_NAMESPACE::PhysicalDevice device, VSL_NAMESPACE::Surface<V> surface)
{
...
VSL_NAMESPACE::LogicalDevice<C, V>::LogicalDevice(VSL_NAMESPACE::PhysicalDevice _device, vsl::Surface<V> _surface)
{
	C c;
	// TODO _data = c.create(_device, _surface);
	// _data->parentDevice = _device._data;
	// _data->parentSurface = _surface._data;
}

template<typename C, bool V>
VSL_NAMESPACE::LogicalDevice<C, V>::LogicalDevice(VSL_NAMESPACE::PhysicalDevice _device, std::shared_ptr<vsl::Surface<V>> _surface) {
	C c;
	// TODO _data = c.create(_device, (vsl::Surface<V>)(*_surface));
	// _data->parentDevice = _device._data;
	// _data->parentSurface = _surface->_data;
}
